 ...
 */
package org.zhaoqian.common.exception.handler;
...
import org.zhaoqian.common.exception.handler.jsf.qualifier.FacesRequestLiteral;
	...
	public void handle() throws FacesException
	{
		...
		while (it.hasNext())
		{
			try
			{
				...
				// Fires the Event with the Exception (with expected Qualifier)
				// to
				// be handled
